...
export const PromptDetailsModal = () => {
  ...
  return (
    <>
      <div
        className="fixed inset-0 bg-[#0f172a]/80 backdrop-blur-sm flex items-center justify-center p-4 z-[80]"
        onClick={() => setSelectedPromptForDetails(null)}
      >
        <div
          className="bg-[#1e293b] rounded-xl max-w-2xl w-full flex flex-col shadow-2xl relative max-h-[95vh] overflow-hidden border border-[#334155]"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="p-4 border-b border-[#334155] flex justify-between items-center bg-[#0f172a]">
            <h2 className="text-xl font-bold text-[#f8fafc] max-w-[80%] truncate">
              {prompt.title}
            </h2>
            <button
              onClick={() => setSelectedPromptForDetails(null)}
              ...
              {isPremiumLocked ? (
                <div className="bg-[#0f172a] border border-[#334155] p-4 rounded-lg flex flex-col items-center justify-center gap-2 text-[#94a3b8] select-none h-32 blur-sm">
                  <span className="text-sm">
                    هذا البرومبت مدفوع، يرجى الترقية لنسخه واستخدامه.
                  </span>
                </div>
              ) : (
                <div
                  className="bg-[#0f172a] border border-[#334155] p-4 rounded-lg text-[#94a3b8] text-sm leading-relaxed"
                  dir="ltr"
                >
                  {prompt.promptText || ""}
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-2">
              ...
              >
                {copied ? (
                  ...
                  <>
                    <Crown size={18} /> شراء النسخة المدفوعة لنسخ البرومبت
                  </>
                ) : (
                  <>
                    <Copy size={18} /> نسخ البرومبت
                  </>
                )}
              </button>
              ...
              {!isPremiumLocked && (
                <div className="flex justify-center gap-2 flex-wrap">
                  ...
                  <button
                    ...
                    className="p-3 bg-black text-white rounded-lg hover:bg-black/80 transition-colors border border-[#334155]"
                  ...
                  <button
                    ...
                    className="p-3 bg-[#25D366] text-white rounded-lg hover:bg-[#25D366]/90 transition-colors"
                  ...
                  <button
                    ...
                    className="p-3 bg-[#229ED9] text-white rounded-lg hover:bg-[#229ED9]/90 transition-colors"
